...
curl https://server.vijge.net/static/cubox/android/android-4.4.2-1.0.1c-ga-aaf118bb78-gapps.img.xz --progress --insecure | unxz | dd of=/dev/mmcblk0 bs=1M conv=fsync
sync
